...
API kiểm tra Roblox user ID, timestamp, khoảng số, item key và giới hạn 30 request/phút/scanner. Account mới được lưu vào Supabase; dashboard chỉ đọc lại khi mở trang hoặc khi bạn bấm nút `Làm mới`.
