...
export const trackedItems: TrackedItem[] = [
  { id: "godhuman", name: "Godhuman", short: "GH", kind: "melee", color: "#e6b84b", icon: "" },
  { id: "sanguine_art", name: "Sanguine Art", short: "SA", kind: "melee", color: "#c94b5f", icon: "" },
  { id: "cursed_dual_katana", name: "Cursed Dual Katana", short: "CDK", kind: "sword", color: "#7e5ce5", icon: "" },
  { id: "shark_anchor", name: "Shark Anchor", short: "ANCH", kind: "sword", color: "#428db5", icon: "" },
  { id: "mirror_fractal", name: "Mirror Fractal", short: "MF", kind: "material", color: "#69b9c8", icon: "" },
  { id: "dark_fragment", name: "Dark Fragment", short: "DF", kind: "material", color: "#6950a8", icon: "" },
  { id: "valkyrie_helm", name: "Valkyrie Helm", short: "VH", kind: "accessory", color: "#d28a45", icon: "" },
  { id: "skull_guitar", name: "Skull Guitar", short: "SG", kind: "gun", color: "#9c62d2", icon: "" },
